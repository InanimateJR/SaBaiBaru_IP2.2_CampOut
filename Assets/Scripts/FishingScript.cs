...
public class FishingScript : MonoBehaviour
{
    ...
    {
        // Did we hit fishable Water with Raycast? T$$anonymous$$s is determined by simple bool on supplemental 
    ...
    private IEnumerator ActionMain()
    {
        ...
        while(!wasInterrupted && thisRun > 0) {
            ...
            // When t$$anonymous$$sRun equals Random biteAt, "Fish On!" (unless it's a dead cycle)
